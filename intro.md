...
| Date        | Topics                                                                    |
| ----------- | ------------------------------------------------------------------------- |
| 09.04.2026  | [Data Acquisition and Labeling](DSW/session1_data_acquisition.ipynb)          |
| 16.04.2026  | [Kubernetes Cluster and Experiments Logging](DSW/session2_cluster.ipynb)      |
| 23.04.2026  | [Data Exploration, Preprocessing & Quality](DSW/session3_data_quality.ipynb)  |
| 30.04.2026  | [Model Training and Evaluation](DSW/session4_model_training_evaluation.ipynb) |
| 07.05.2026  | [Dashboards and Demos](DSW/session5_demos.ipynb)                              |
